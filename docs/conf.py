# -*- coding: utf-8 -*-
#
# django-pgmigrate documentation build configuration file, created by
...
htmlhelp_basename = "django-pgmigratedoc"
...
latex_documents = [
    (
        master_doc,
        "django-pgmigrate.tex",
        "django-pgmigrate Documentation",
        "Opus 10",
        "manual",
    )
]
