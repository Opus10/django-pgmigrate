...
Set up your development environment with:
    ...
    git clone git@github.com:Opus10/django-pgmigrate.git
    cd django-pgmigrate
    make docker-setup
...
Anything that is merged into the master branch will be automatically deployed to PyPI. Documentation will be published to a ReadTheDocs at `https://django-pgmigrate.readthedocs.io/`.
